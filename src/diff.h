...
extern void print_created_filename_chain(void);
extern void print_modified_filename_chain(void);
extern void print_deleted_filename_chain(void);
extern void print_all_filename_chain(void);
extern void enqueue_created_filename(char const *);
extern void enqueue_modified_filename(char const *);
extern void enqueue_deleted_filename(char const *);
